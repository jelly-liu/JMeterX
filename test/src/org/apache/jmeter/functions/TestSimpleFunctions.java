...
public class TestSimpleFunctions extends JMeterTestCase {
    ...
    @Test
    public void testMD5ParameterCount() throws Exception {
        AbstractFunction function = new MD5();
    ...
    public void testMD5() throws Exception {
        AbstractFunction function = new MD5();
        params.add(new CompoundVariable("123"));
        function.setParameters(params);
        String ret = function.execute(result, null);
        assertEquals(ret, "202cb962ac59075b964b07152d234b70");
    }
